      ...
      Program "vp"
      {
        SubProgram "gles hw_tier00"
        {
          ...
          void main ()
          {
            ...
            highp vec4 color_2;
            highp vec4 tmpvar_3;
            tmpvar_3 = (xlv_TEXCOORD * _Color);
            color_2.xyz = (tmpvar_3.xyz * tmpvar_3.w);
            color_2.w = (tmpvar_3.w * _Opacity);
            tmpvar_1 = color_2;
        ...
        SubProgram "gles3 hw_tier00"
        {
          ...
          void main()
          {
              u_xlat0 = vs_TEXCOORD0 * _Color;
              u_xlat1.xyz = u_xlat0.www * u_xlat0.xyz;
              u_xlat1.w = u_xlat0.w * _Opacity;
              SV_Target0 = u_xlat1;
              return;
          }
