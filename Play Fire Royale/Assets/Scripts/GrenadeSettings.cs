// DecompilerFi decompiler from Assembly-CSharp.dll class: GrenadeSettings
...
namespace CoverShooter
{
	...
	public struct GrenadeSettings
	{
		...
		{
			GrenadeSettings result = default(GrenadeSettings);
			result.MaxVelocity = 10f;
			result.Gravity = 12.5f;
			result.Step = 0.05f;
			result.StandingOrigin = new Vector3(0.33f, 1.88f, 0f);
			result.CrouchOrigin = new Vector3(0.5f, 1.43f, 0f);
			result.DropOnHit = true;
			return result;
		}
	}
}
