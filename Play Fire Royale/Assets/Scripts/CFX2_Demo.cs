// DecompilerFi decompiler from Assembly-CSharp.dll class: CFX2_Demo
...
public class CFX2_Demo : MonoBehaviour
{
	...
	private void OnMouseDown()
	{
		...
		if (GetComponent<Collider>().Raycast(Camera.main.ScreenPointToRay(CF2Input.mousePosition), out hitInfo, 9999f))
		{
