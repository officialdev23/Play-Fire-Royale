// DecompilerFi decompiler from Assembly-CSharp-firstpass.dll class: ControlFreak2.Demos.Helpers.SplitScreenCamAddOn
	...
	public class SplitScreenCamAddOn : MonoBehaviour
	{
		...
		private void LateUpdate()
		{
			if (!(cam == null))
			{
				...
				Vector2 vector = new Vector3(Mathf.Abs(Mathf.Sin((float)Math.PI / 180f * rotationAngle)), Mathf.Abs(Mathf.Cos((float)Math.PI / 180f * rotationAngle)));
