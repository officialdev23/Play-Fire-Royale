// DecompilerFi decompiler from Assembly-CSharp-firstpass.dll class: ControlFreak2.DebugUtils.AxisDebugger
	...
	public class AxisDebugger : MonoBehaviour
	{
		...
		private void Update()
		{
			...
			cfScroll += CF2Input.mouseScrollDelta;
			 Vector2 reference =  unScroll;
			float x = reference.x;
			Vector2 mouseScrollDelta = Input.mouseScrollDelta;
			reference.x = x + mouseScrollDelta.x;
			 Vector2 reference2 =  unScroll;
