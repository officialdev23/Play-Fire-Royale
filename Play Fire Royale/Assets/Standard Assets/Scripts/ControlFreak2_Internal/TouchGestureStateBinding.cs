// DecompilerFi decompiler from Assembly-CSharp-firstpass.dll class: ControlFreak2.Internal.TouchGestureStateBinding
...
namespace ControlFreak2.Internal
{
	...
	public class TouchGestureStateBinding : InputBindingBase
	{
			...
			: base(parent)
		{
			...
			rawPressMousePosBinding = new MousePositionBinding(10,  false, this);
			normalPressMousePosBinding = new MousePositionBinding(20,  false, this);
			longPressMousePosBinding = new MousePositionBinding(20,  false, this);
			tapMousePosBinding = new MousePositionBinding(30,  false, this);
			doubleTapMousePosBinding = new MousePositionBinding(30,  false, this);
			longTapMousePosBinding = new MousePositionBinding(30,  false, this);
			normalPressSwipeMousePosBinding = new MousePositionBinding(20,  false, this);
			longPressSwipeMousePosBinding = new MousePositionBinding(20,  false, this);
