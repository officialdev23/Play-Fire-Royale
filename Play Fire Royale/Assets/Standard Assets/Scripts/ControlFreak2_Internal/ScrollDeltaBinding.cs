// DecompilerFi decompiler from Assembly-CSharp-firstpass.dll class: ControlFreak2.Internal.ScrollDeltaBinding
...
namespace ControlFreak2.Internal
{
	...
	public class ScrollDeltaBinding : InputBindingBase
	{
		...
		public ScrollDeltaBinding(InputBindingBase parent = null)
			: base(parent)
		{
			deltaBinding = new AxisBinding("Mouse ScrollWheel",  false, this);
		...
		public void SyncScrollDelta(int delta, InputRig rig)
		{
			...
			if (delta != 0)
			{
				if (delta > 0)
				{
					positiveDigitalBinding.Sync( true, rig);
				}
				else
				{
					negativeDigitalBinding.Sync( true, rig);
				}
			}
		}
