// DecompilerFi decompiler from Assembly-CSharp-firstpass.dll class: ControlFreak2.GamepadManager
		...
		public class Gamepad
		{
			...
			public Gamepad(GamepadManager manager)
			{
				...
				for (int k = 0; k < keys.Length; k++)
				{
					...
					case 6:
					case 8:
						keys[k] = new KeyState(this, true, manager.fallbackLeftTriggerAnalogConfig);
						break;
					case 7:
					case 9:
						keys[k] = new KeyState(this, true, manager.fallbackRightTriggerAnalogConfig);
						break;
					default:
						keys[k] = new KeyState(this, false);
						break;
					}
				}
				OnDisconnect();
