// DecompilerFi decompiler from Assembly-CSharp-firstpass.dll class: ControlFreak2.SuperTouchZoneSpriteAnimator
...
namespace ControlFreak2
{
	...
	public class SuperTouchZoneSpriteAnimator : TouchControlSpriteAnimatorBase, ISpriteAnimator
	{
		...
		{
			spriteRawPress = new SpriteConfig( true,  false, 1.2f);
			spriteNormalPress = new SpriteConfig( false,  false, 1.2f);
			spriteLongPress = new SpriteConfig( false,  false, 1.2f);
			spriteTap = new SpriteConfig( false,  true, 1.2f);
			spriteDoubleTap = new SpriteConfig( false,  true, 1.2f);
			spriteLongTap = new SpriteConfig( false,  true, 1.2f);
			spriteNormalScrollU = new SpriteConfig( false,  true, 1.2f);
			spriteNormalScrollR = new SpriteConfig( false,  true, 1.2f);
			spriteNormalScrollD = new SpriteConfig( false,  true, 1.2f);
			spriteNormalScrollL = new SpriteConfig( false,  true, 1.2f);
			spriteLongScrollU = new SpriteConfig( false,  true, 1.2f);
			spriteLongScrollR = new SpriteConfig( false,  true, 1.2f);
			spriteLongScrollD = new SpriteConfig( false,  true, 1.2f);
			spriteLongScrollL = new SpriteConfig( false,  true, 1.2f);
		}
