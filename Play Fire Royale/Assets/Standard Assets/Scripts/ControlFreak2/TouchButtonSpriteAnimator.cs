// DecompilerFi decompiler from Assembly-CSharp-firstpass.dll class: ControlFreak2.TouchButtonSpriteAnimator
...
namespace ControlFreak2
{
	...
	public class TouchButtonSpriteAnimator : TouchControlSpriteAnimatorBase, ISpriteAnimator
	{
		...
		{
			spritePressed = new SpriteConfig( true,  false, 1.2f);
			spriteToggled = new SpriteConfig( false,  false, 1.1f);
			spriteToggledAndPressed = new SpriteConfig( false,  false, 1.3f);
