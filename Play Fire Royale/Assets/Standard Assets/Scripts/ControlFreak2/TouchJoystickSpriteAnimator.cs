// DecompilerFi decompiler from Assembly-CSharp-firstpass.dll class: ControlFreak2.TouchJoystickSpriteAnimator
...
namespace ControlFreak2
{
	...
	public class TouchJoystickSpriteAnimator : TouchControlSpriteAnimatorBase, ISpriteAnimator
	{
			...
			: base(typeof(TouchJoystick))
		{
			...
			spriteNeutralPressed = new SpriteConfig( true,  false, 1.2f);
			spriteUp = new SpriteConfig( false,  false, 1.2f);
			spriteUpRight = new SpriteConfig( false,  false, 1.2f);
			spriteRight = new SpriteConfig( false,  false, 1.2f);
			spriteDownRight = new SpriteConfig( false,  false, 1.2f);
			spriteDown = new SpriteConfig( false,  false, 1.2f);
			spriteDownLeft = new SpriteConfig( false,  false, 1.2f);
			spriteLeft = new SpriteConfig( false,  false, 1.2f);
			spriteUpLeft = new SpriteConfig( false,  false, 1.2f);
		}
