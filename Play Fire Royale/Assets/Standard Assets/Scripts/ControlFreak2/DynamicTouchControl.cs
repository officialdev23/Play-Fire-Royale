// DecompilerFi decompiler from Assembly-CSharp-firstpass.dll class: ControlFreak2.DynamicTouchControl
...
namespace ControlFreak2
{
	public abstract class DynamicTouchControl : TouchControl
	{
		...
		public TouchGestureBasicState TouchStateScreen => touchStateScreen;

		public TouchGestureBasicState TouchStateOriented => touchStateOriented;

		public TouchGestureBasicState TouchStateWorld => touchStateWorld;
		...
		protected void StoreDefaultPos()
		{
			if (!CFUtils.editorStopped)
			{
				...
				initialRectCopyGo.hideFlags = HideFlags.HideAndDontSave;
